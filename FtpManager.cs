...
namespace FtpManager
{
    public class FtpManager : IDisposable
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether this <see cref="FtpManager"/> is a valid connection.
        /// </summary>
        /// <value>
        ...
        ///     Creates the folder.
        /// </summary>
        /// <param name="newDirectory">The new directory. Write @"yourcompany\test\test2\test3" for example.</param>
        ...
        /// </summary>
        /// <param name="ftpFilePath">The file path. Write @"yourcompany\test\test2" for example.</param>
        public void DeleteDirectory(string ftpDirectory)
        {
            foreach (var file in this.GetFileList(ftpDirectory))
                this.DeleteFile(ftpDirectory + '\\' + file.Split('/')[file.Split('/').Length - 1]);

            try
            {
                var ftpWebRequest = (FtpWebRequest)WebRequest.Create(new Uri("ftp://" + this.Server + "/" + ftpDirectory));
                ftpWebRequest.Credentials = new NetworkCredential(this.User, this.Password);
                ftpWebRequest.UseBinary = true;
                ftpWebRequest.Proxy = null;
                ftpWebRequest.KeepAlive = false;
        ...
        ///     Deletes the file.
        /// </summary>
        /// <param name="ftpFilePath">The file path. Write @"yourcompany\test\NinjaReport.txt" for example.</param>
        ...
        /// </summary>
        /// <param name="directory">Directory to test. Write @"yourcompany\test\test2\" for example. The "\" at the end is important.</param>
        /// <returns></returns>
        ...
        ///     Downloads the file.
        /// </summary>
        /// <param name="ftpFilePath">The client file path. Write @"yourcompany\test\NinjaReport.txt" for example.</param>
        /// <param name="destinationFilePath">The destination file path. Write @"C:\Users\Zoidberg\Desktop\NinjaReport.txt" for example.</param>
        ...
        /// </summary>
        /// <param name="directory">The directory. Write @"yourcompany\test\" for example.</param>
        /// <returns></returns>
        ...
        ///     Uploads the file.
        /// </summary>
        /// <param name="filPath">The client file path. Write @"C:\Users\Zoidberg\Desktop\SamuraiReport.txt" for example.</param>
        /// <param name="direcotry">The direcotry. Write @"yourcompany\test\test2" for example.</param>
        ...
        ///     Uploads the file.
        /// </summary>
        /// <param name="filePath">The file path. Write @"C:\Users\Zoidberg\Desktop\SamuraiReport.txt" for example.</param>
